...
export default function WorkProcessTeaser() {
  ...
  return (
    ...
    >
      {/* Subtle violet bloom in the corner — picks up the hero+CTA
          accent without competing with them. */}
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 -left-40 h-[400px] w-[400px] rounded-full opacity-30"
        style={{
      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-6 sm:px-8 lg:px-14 xl:px-20 py-20 sm:py-24 lg:py-28">
        <div className="flex items-baseline justify-between gap-6 mb-12 sm:mb-16">
          ...
          <Link
            href="/process"
            className="hidden sm:inline-flex items-baseline gap-2 font-mono text-[11px] uppercase tracking-[0.22em] text-background/55 hover:text-background transition-colors focus-ring rounded-md"
            style={{ fontFamily: "var(--font-mono), 'JetBrains Mono', monospace" }}
          >
            Full method
        ...
        {/* Headline — repeats the same italic-accent treatment as the
            other sections so the page bookends cohere. */}
        <h2
          className="font-medium text-background leading-[1.02] max-w-4xl"
          style={{
        ...
        >
          Scope. Ship.{" "}
          <span
            className="italic text-accent-violet"
            style={{
        ...
        <p className="mt-6 max-w-2xl text-lg sm:text-xl text-background/75 leading-relaxed">
        ...
        <div className="relative mt-16 sm:mt-20">
          {/* Progress rail — full-width hairline behind the cards.
              ...
              as a left→right draw. */}
          <div
            aria-hidden
            className="absolute left-0 right-0 top-[34px] sm:top-[40px] h-px bg-background/15 z-0"
          />
          {mounted ? (
            <motion.div
              aria-hidden
              ...
              >
                <div className="flex flex-col gap-5">
                  {/* Step dot — sits on top of the progress rail so the
                      line appears to pass behind each step. The dot's
                      accent matches the gradient stops on the rail. */}
                  <span
                    aria-hidden
                    className="inline-flex h-[68px] w-[68px] sm:h-[80px] sm:w-[80px] items-center justify-center rounded-full bg-foreground border border-background/20"
                  >
                    <span
                    ...
                    >
                      <span
                        className="font-mono text-sm sm:text-base font-medium tabular-nums text-accent-violet"
                        style={{
                          fontFamily:
                  ...
                  <div>
                    <h3
                      className="font-medium text-background leading-tight"
                      style={{
                    ...
                    <p className="mt-3 text-base sm:text-lg text-background/75 leading-relaxed max-w-xs">
                      {step.blurb}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-12 sm:hidden">
          <Link
            href="/process"
            className="inline-flex items-baseline gap-2 font-mono text-xs uppercase tracking-[0.22em] text-background/70 hover:text-background transition-colors focus-ring rounded-md"
            style={{ fontFamily: "var(--font-mono), 'JetBrains Mono', monospace" }}
          >
            See the full method
            <span aria-hidden>→</span>
