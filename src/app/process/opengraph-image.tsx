...
/**
 * /process OG image — auto-served at /process/opengraph-image (Next 16
 * convention). Previews when a /process URL is shared.
 *
 * Mirrors the root + /about share-card geometry so the brand
 * silhouette stays consistent. Copy is /process-specific:
 *   • Headline: "We crush it to two weeks." — the live hero headline,
 *     with "two weeks." as the italic-serif accent (matches ProcessHero).
 *   • Proof line: the cadence promise so a thumbnail carries the pitch.
 *
...
export const alt =
  "TGlobal — We crush it to two weeks. Fixed-cost sprints, a demo every Friday, live in production by the second one.";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Headline — the live hero line; "two weeks." highlighted as
            the italic accent. Stacked two lines so the longer phrase
        ...
        >
          <div style={{ display: "flex" }}>We crush it to</div>
        ...
        {/* Bottom row — cadence promise + url. */}
        <div
          style={{
            display: "flex",
            justifyContent: "space-between",
        ...
        >
          ...
          >
            Fixed-cost sprints · a demo every Friday · live by the second
          </div>
          <div
            style={{
              display: "flex",
